...
export const ORDER_ALL_LIST_REQUEST = 'ORDER_ALL_LIST_MY_REQUEST';
export const ORDER_ALL_LIST_SUCCESS = 'ORDER_ALL_LIST_MY_SUCCESS';
export const ORDER_ALL_LIST_FAIL = 'ORDER_ALL_LIST_MY_FAIL';
